...
export const VRAT_DATA: VratEntry[] = [
  ...
  { date: "2026-05-31", name: "Adhika Jyeshtha Purnima", type: "purnima", month: "Adhika Jyeshtha", significance: "Rare extra Purnima — Purushottam Maas, highly meritorious", special: true },
  ...
  { date: "2026-03-19", name: "Phalguna Amavasya", type: "amavasya", month: "Phalguna", significance: "Eve of Hindu New Year", special: true },
  ...
  { date: "2026-09-11", name: "Bhadrapada Amavasya (Mahalaya)", type: "amavasya", month: "Bhadrapada", significance: "Sarva Pitru Amavasya — most important ancestor day", special: true },
  { date: "2026-10-10", name: "Ashwina Amavasya", type: "amavasya", month: "Ashwina", significance: "Navratri begins next day" },
  ...
  { date: "2025-03-25", name: "Amalaki Ekadashi", type: "ekadashi", paksha: "shukla", month: "Phalguna", significance: "Worship of Amalaki tree — Lord Vishnu's abode", special: true },
  ...
  { date: "2026-02-27", name: "Amalaki Ekadashi", type: "ekadashi", paksha: "shukla", month: "Phalguna", significance: "Worship of Amalaki tree — Lord Vishnu's abode", special: true },
  ...
  { date: "2026-03-30", name: "Kamada Ekadashi", type: "ekadashi", paksha: "shukla", month: "Chaitra", significance: "Fulfills all desires, cleanses sins" },
  ...
  { date: "2026-07-24", name: "Devshayani Ekadashi", type: "ekadashi", paksha: "shukla", month: "Ashadha", significance: "Lord Vishnu begins cosmic sleep — Chaturmas starts", special: true },
  ...
  { date: "2026-09-21", name: "Parsva Ekadashi", type: "ekadashi", paksha: "shukla", month: "Bhadrapada", significance: "Vishnu turns over in cosmic sleep" },
  ...
  { date: "2026-11-22", name: "Dev Uthani Ekadashi", type: "ekadashi", paksha: "shukla", month: "Kartika", significance: "Vishnu wakes from cosmic sleep — auspicious ceremonies resume", special: true },
...
export const VRAT_TYPE_META: Record<VratEntry["type"], { label: string; icon: string; bg: string; text: string; border: string }> = {
  ekadashi:  { label: "Ekadashi",            icon: "🌙", bg: "#EEF2FF", text: "#3730A3", border: "#A5B4FC" },
  amavasya:  { label: "Amavasya",            icon: "🌑", bg: "#F1F5F9", text: "#334155", border: "#CBD5E1" },
  purnima:   { label: "Purnima",             icon: "🌕", bg: "#FEF3C7", text: "#92400E", border: "#FCD34D" },
  pradosh:   { label: "Pradosh Vrat",        icon: "🕉️", bg: "#FFF7ED", text: "#9A3412", border: "#FDBA74" },
  sankashti: { label: "Sankashti Chaturthi", icon: "🐘", bg: "#ECFDF5", text: "#065F46", border: "#6EE7B7" },
  other:     { label: "Other Vrat",          icon: "✨", bg: "#F5F3FF", text: "#5B21B6", border: "#C4B5FD" },
};
