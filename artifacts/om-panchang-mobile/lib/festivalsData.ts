...
export const FESTIVALS: FestivalDetail[] = [
  {
    ...
    related: ["dhanteras", "bhai-dooj", "chhath-puja"],
    metaDescription: "Diwali 2026 date is November 8. Get accurate Lakshmi Puja muhurat, rituals, mantras, and the complete 5-day Diwali calendar on Om Panchang.",
  },
...

  {
    ...
    metaDescription: "Bhai Dooj 2026 falls on November 11. Get Bhai Dooj tilak muhurat, rituals, story, and significance on Om Panchang.",
  },
...

  {
    ...
    rituals: [
      ...
      "Perform daily aarti morning and evening for the duration of the festival",
    ...
    related: ["diwali", "navratri"],
    metaDescription: "Ganesh Chaturthi 2026 falls on September 14, with visarjan on September 24. Get Madhyahna puja muhurat, moon-avoidance time, and 10-day festival guide.",
  },

  {
    ...
    related: ["dussehra", "diwali"],
    metaDescription: "Sharad Navratri 2026 begins October 11 and ends with Dussehra on October 20. Get Ghatasthapana muhurat, day-wise goddesses, colors, and fasting rules.",
  },

  {
    ...
    significance: "Dussehra (Dasha-hara, 'remover of ten') falls on the tenth day of Shukla Paksha in Ashwina month. It marks the day Lord Rama killed Ravana, the ten-headed demon king of Lanka. It also marks the tenth day of the Durga Puja, when Goddess Durga is bid farewell after defeating Mahishasura. The day is considered one of the most auspicious for starting any new venture.",
    ...
    metaDescription: "Dussehra (Vijayadashami) 2026 falls on October 20. Get Vijaya muhurat, Aparahna puja time, Ravana Dahan timing, and significance.",
  },

  {
    ...
    significance: "Karwa Chauth (Karwa = earthen pot, Chauth = fourth) falls on the Krishna Paksha Chaturthi of Kartik month, four days after Diwali. The fast is one of the most significant for married Hindu women — they observe a complete waterless fast from sunrise until they sight the moon at night.",
    ...
    related: ["diwali", "raksha-bandhan"],
    metaDescription: "Karwa Chauth 2026 falls on October 30. Get city-wise moonrise time, puja muhurat, sargi tradition, and complete ritual guide for married women.",
  },

  {
    ...
    significance: "Chhath Puja is one of the oldest Vedic festivals, primarily celebrated in Bihar, Jharkhand, eastern UP, and Nepal. It is dedicated to Surya Dev, the source of all life, and is performed to thank the sun for sustaining life on earth.",
    ...
    related: ["diwali"],
    metaDescription: "Chhath Puja 2026 dates: Nov 14-17. Get all 4-day rituals (Nahay Khay, Kharna, Sandhya Arghya, Usha Arghya), sunrise/sunset times, and significance.",
  },

  {
    ...
    story: "Sage Veda Vyasa was born on this day to Sage Parashara and Satyavati. He is the author of the Mahabharata, the Brahma Sutras, and the compiler/divider of the Vedas into four parts (Rig, Yajur, Sama, Atharva). He is considered the Adi Guru (first guru) of the Hindu tradition.",
    rituals: [
    ...
    related: ["raksha-bandhan", "janmashtami"],
    metaDescription: "Guru Purnima 2026 falls on July 29. Get Purnima tithi timings, Vyasa Puja time, Guru Stotra, and rituals to honor your teachers.",
  },

  {
    ...
    story: "Prince Siddhartha Gautama was born to King Shuddhodana and Queen Maya in Lumbini. At age 29, disturbed by the suffering he saw in the world, he renounced his princely life and went in search of truth. After six years of austerities, he attained enlightenment under the Bodhi tree at Bodh Gaya at age 35. He preached the Four Noble Truths and the Eightfold Path for 45 years before attaining Mahaparinirvana at Kushinagar at age 80 — all events occurring on Vaishakh Purnima.",
    rituals: [
    ...
    metaDescription: "Buddha Purnima 2026 falls on May 1. Celebrate the birth, enlightenment, and Mahaparinirvana of Lord Buddha with rituals and mantras on Om Panchang.",
  },

  {
    ...
    metaDescription: "Akshaya Tritiya 2026 falls on April 18. Get gold-buying muhurat, Vishnu-Lakshmi puja timings, and significance of this most auspicious day.",
  },

  {
    ...
    significance: "Holi is celebrated on the day after the full moon of Phalguna month (Phalguna Purnima). It marks the end of winter and arrival of spring. The previous evening, Holika Dahan symbolizes the burning of evil — based on the legend of Prahlad's escape from Holika's fire.",
    story: "King Hiranyakashipu was granted a boon making him nearly invincible. He demanded everyone worship him as god. But his own son, Prahlad, was a devoted devotee of Lord Vishnu. After many failed attempts to kill Prahlad, Hiranyakashipu enlisted his sister Holika, who had a boon to be immune to fire. Holika sat on a pyre with Prahlad on her lap, but Vishnu's grace reversed the boon — Holika was burnt to ashes while Prahlad emerged unharmed, chanting Vishnu's name.",
    rituals: [
    ...
    related: ["ram-navami"],
    metaDescription: "Holi 2026 falls on March 4 with Holika Dahan on March 3. Get accurate Dahan muhurat avoiding Bhadra, story of Holika and Prahlad, and rituals.",
  },

  {
    ...
    related: ["navratri"],
    metaDescription: "Maha Shivratri 2026 falls on February 16. Get all 4 prahar puja timings, Nishita Kaal muhurat, abhishek rituals, fasting rules, and Shiva mantras.",
  },

  {
    ...
    story: "King Dasharatha of Ayodhya had three queens but no son. He performed the Putrakameshti Yajna under the guidance of Sage Rishyashringa. From the sacrificial fire emerged a divine being with a bowl of payasam (sweet pudding), which the three queens consumed. Soon all three were pregnant. Queen Kausalya gave birth to Rama at noon on Chaitra Navami. Lord Vishnu had taken birth as Rama to slay the demon king Ravana.",
    rituals: [
    ...
    metaDescription: "Ram Navami 2026 falls on March 27. Get Madhyahna puja muhurat (Rama's birth time), fasting rules, and rituals to celebrate Lord Rama's birth.",
  },
...

  {
    ...
    significance: "Ugadi/Gudi Padwa marks the start of the Hindu Lunar New Year (Chaitra Shukla Pratipada). It is one of the most auspicious days — one of the four Sade Teen Muhurat days that need no further astrological consultation. The Vikram Samvat calendar advances by one year on this day.",
    story: "Lord Brahma is believed to have started the creation of the universe on this day. It is also the day Lord Rama was crowned king of Ayodhya after returning from exile and defeating Ravana. In Maharashtra, the Gudi (a bamboo pole with a brass pot, neem leaves, and a colorful cloth) is hoisted as a symbol of victory and prosperity.",
    rituals: [
      ...
      "Wear new clothes",
      "Prepare and eat Ugadi Pachadi — a unique dish with six tastes representing all flavors of life",
...
export const FESTIVAL_SLUG_MAP: Record<string, string> = {
  "Diwali": "diwali",
  "Deepavali": "diwali",
  "Dhanteras": "dhanteras",
  "Dhanvantari Trayodashi": "dhanteras",
  "Bhai Dooj": "bhai-dooj",
  "Bhau Beej": "bhai-dooj",
...
export function getSlugForFestivalName(name: string): string | undefined {
  for (const [key, slug] of Object.entries(FESTIVAL_SLUG_MAP)) {
