...
export const YOGA_DATA: YogaInfo[] = [
  { index: 1, name: "Vishkambha", nature: "Inauspicious", description: "Obstructed, best avoided for new ventures." },
  { index: 2, name: "Priti", nature: "Auspicious", description: "Love and affection; good for romantic activities." },
  { index: 3, name: "Ayushman", nature: "Auspicious", description: "Long life; auspicious for health-related activities." },
  { index: 4, name: "Saubhagya", nature: "Auspicious", description: "Good fortune; excellent for all activities." },
  { index: 5, name: "Shobhana", nature: "Auspicious", description: "Splendor; good for beautification and celebration." },
  { index: 6, name: "Atiganda", nature: "Inauspicious", description: "Great danger; avoid important undertakings." },
  { index: 7, name: "Sukarma", nature: "Auspicious", description: "Good deeds; excellent for virtuous activities." },
  { index: 8, name: "Dhriti", nature: "Auspicious", description: "Firmness; good for steady, long-term work." },
  { index: 9, name: "Shula", nature: "Inauspicious", description: "Pain; avoid delicate activities." },
  { index: 10, name: "Ganda", nature: "Inauspicious", description: "Danger; inauspicious for most undertakings." },
  { index: 11, name: "Vriddhi", nature: "Auspicious", description: "Growth; excellent for expansion and prosperity." },
  { index: 12, name: "Dhruva", nature: "Auspicious", description: "Fixed; good for permanent and lasting activities." },
  { index: 13, name: "Vyaghata", nature: "Inauspicious", description: "Tiger; destructive energy, avoid important work." },
  { index: 14, name: "Harshana", nature: "Auspicious", description: "Joy; good for celebrations and happiness." },
  { index: 15, name: "Vajra", nature: "Mixed", description: "Thunderbolt; powerful but can cut both ways." },
  { index: 16, name: "Siddhi", nature: "Auspicious", description: "Success; highly auspicious for all activities." },
  { index: 17, name: "Vyatipata", nature: "Inauspicious", description: "Calamity; one of the most inauspicious yogas." },
  { index: 18, name: "Variyana", nature: "Auspicious", description: "Comfort; good for pleasure and enjoyment." },
  { index: 19, name: "Parigha", nature: "Inauspicious", description: "Obstruction; avoid beginning new work." },
  { index: 20, name: "Shiva", nature: "Auspicious", description: "Auspicious; especially good for Shiva worship." },
  { index: 21, name: "Siddha", nature: "Auspicious", description: "Accomplished; excellent for perfecting skills." },
  { index: 22, name: "Sadhya", nature: "Auspicious", description: "Achievable; good for accomplishing tasks." },
  { index: 23, name: "Shubha", nature: "Auspicious", description: "Auspicious; very good for all activities." },
  { index: 24, name: "Shukla", nature: "Auspicious", description: "Bright; excellent for starting new endeavors." },
  { index: 25, name: "Brahma", nature: "Auspicious", description: "Creator; good for creative and intellectual work." },
  { index: 26, name: "Indra", nature: "Auspicious", description: "King of gods; excellent for leadership activities." },
  { index: 27, name: "Vaidhriti", nature: "Inauspicious", description: "Inauspicious; avoid important undertakings." },
];
